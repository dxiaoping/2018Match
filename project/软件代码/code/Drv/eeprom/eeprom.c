...
/*!< Select the EEPROM address according to the state of A0, A1, A2 pins */
  sEEAddress = sEE_HW_ADDRESS;  
#else
  #error "you should define the eeprom device type"
#endif /*!< sEE_M24C64_32 */    
}
...
#elif defined (sEE_M24C64_32) || defined (sEE_FM24C128)
