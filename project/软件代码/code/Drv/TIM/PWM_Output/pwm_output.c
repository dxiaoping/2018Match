...
uint16_t mCCR1_Val = TIM3_CCR_MIN;
uint16_t mCCR2_Val = TIM3_CCR_MIN;
uint16_t mCCR3_Val = TIM3_CCR_MIN;
uint16_t mCCR4_Val = TIM3_CCR_MIN;
...
void TIM3_pwm_init(void)
{
  ...
  TIM_OCInitStructure.TIM_OutputState = TIM_OutputState_Enable;
  TIM_OCInitStructure.TIM_Pulse = mCCR2_Val;
  ...
  TIM_OCInitStructure.TIM_OutputState = TIM_OutputState_Enable;
  TIM_OCInitStructure.TIM_Pulse = mCCR3_Val;
  ...
  TIM_OCInitStructure.TIM_OutputState = TIM_OutputState_Enable;
  TIM_OCInitStructure.TIM_Pulse = mCCR4_Val;
